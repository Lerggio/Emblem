#ifndef HEROARCHERKLEIN_H
#define HEROARCHERKLEIN_H
...
class HeroArcherKlein : public Cell
{
    public:
        HeroArcherKlein(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
