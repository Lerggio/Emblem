#ifndef HEROARMORAXEHECTOR_H
#define HEROARMORAXEHECTOR_H
...
class HeroArmorAxeHector : public Cell
{
    public:
        HeroArmorAxeHector(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
