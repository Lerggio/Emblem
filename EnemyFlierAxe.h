#ifndef ENEMYFLIERAXE_H
#define ENEMYFLIERAXE_H
...
class EnemyFlierAxe : public Cell
{
    public:
        EnemyFlierAxe(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("genericflieraxe.png");
        }
