#ifndef HEROINFANTRYLANCELUCINA_H
#define HEROINFANTRYLANCELUCINA_H
...
class HeroInfantryLanceLucina : public Cell
{
    public:
        HeroInfantryLanceLucina(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("Lucina.png");

        }

    ~HeroInfantryLanceLucina()
    {
        //dtor
    }
...
#endif // HEROINFANTRYLANCELUCINA_H
