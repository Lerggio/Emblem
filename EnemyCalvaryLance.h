#ifndef ENEMYCALVARYLANCE_H
#define ENEMYCALVARYLANCE_H
...
class EnemyCalvaryLance : public Cell
{
public:
    EnemyCalvaryLance(int i, int j, int k) : Cell(i, j, k)
    {
        x = i;
        y = j;
        z = k;
        ...
        filename = wxT("genericcalvaryspear.png");
