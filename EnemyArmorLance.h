#ifndef ENEMYARMORLANCE_H
#define ENEMYARMORLANCE_H
...
class EnemyArmorLance : public Cell
{
    public:
        EnemyArmorLance(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("genericarmorspear.png");
