#ifndef ENEMYDAGGER_H
#define ENEMYDAGGER_H
...
class EnemyDagger : public Cell
{
    public:
        EnemyDagger(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            counter = 0;
            myColor = wxT("DARK GREY");
            healthPoints = 2;
            type = "Assassin";

            filename = wxT("genericdagger.png");
