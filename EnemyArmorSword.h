#ifndef ENEMYARMORSWORD_H
#define ENEMYARMORSWORD_H
...
class EnemyArmorSword : public Cell
{
    public:
        EnemyArmorSword(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("genericarmorsword.png");
