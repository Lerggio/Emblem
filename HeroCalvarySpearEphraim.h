#ifndef HEROCALVARYSPEAREPHRAIM_H
#define HEROCALVARYSPEAREPHRAIM_H
...
class HeroCalvarySpearEphraim : public Cell
{
public:
    HeroCalvarySpearEphraim(int i, int j, int k) : Cell(i, j, k)
    {
        x = i;
        y = j;
        z = k;
        ...
        filename = wxT("Ephraim.png");

    }

    ~HeroCalvarySpearEphraim()
    {
        //dtor
    }
...
#endif // HEROCALVARYSPEAREPHRAIM_H
