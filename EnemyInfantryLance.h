#ifndef ENEMYINFANTRYLANCE_H
#define ENEMYINFANTRYLANCE_H
...
class EnemyInfantryLance : public Cell
{
    public:
        EnemyInfantryLance(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("genericinfantryspear.png");
