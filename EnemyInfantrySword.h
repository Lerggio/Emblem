#ifndef ENEMYINFANTRYSWORD_H
#define ENEMYINFANTRYSWORD_H
...
class EnemyInfantrySword : public Cell
{
    public:
        EnemyInfantrySword(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("genericinfantrysword.png");
