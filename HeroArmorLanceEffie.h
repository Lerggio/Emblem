#ifndef HEROARMORLANCEEFFIE_H
#define HEROARMORLANCEEFFIE_H
...
class HeroArmorLanceEffie : public Cell
{
    public:
        HeroArmorLanceEffie(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
