#ifndef HEROFLIERLANCECORDELIA_H
#define HEROFLIERLANCECORDELIA_H
...
class HeroFlierLanceCordelia : public Cell
{
    public:
        HeroFlierLanceCordelia(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("Cordelia.png");

        }

    ~HeroFlierLanceCordelia()
    {
        //dtor
    }
...
#endif // HEROFLIERLANCECORDELIA_H
