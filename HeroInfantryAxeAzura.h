#ifndef HEROINFANTRYAXEAZURA_H
#define HEROINFANTRYAXEAZURA_H
...
class HeroInfantryAxeAzura : public Cell
{
    public:
        HeroInfantryAxeAzura(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("Azura.png");

        }

    ~HeroInfantryAxeAzura()
    {
        //dtor
    }
