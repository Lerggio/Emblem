#ifndef HEROFLIERSWORDELINCIA_H
#define HEROFLIERSWORDELINCIA_H
...
class HeroFlierSwordElincia : public Cell
{
    public:
        HeroFlierSwordElincia(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("Elincia.png");

        }

    ~HeroFlierSwordElincia()
    {
        //dtor
    }
