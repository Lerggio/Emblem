#ifndef ENEMYFLIERSWORD_H
#define ENEMYFLIERSWORD_H
...
class EnemyFlierSword : public Cell
{
    public:
        EnemyFlierSword(int i, int j, int k) : Cell(i, j, k)
        {
            x = i;
            y = j;
            z = k;
            ...
            filename = wxT("genericfliersword.png");
        }
